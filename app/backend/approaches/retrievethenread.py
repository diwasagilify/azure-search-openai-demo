...
class RetrieveThenReadApproach(Approach):
    ...
    system_chat_template = (
        "Assistant helps the company employees with their questions about the company benefits, employee handbook, time tracking in Harvest, holidays, PTO, and other employee questions. "
