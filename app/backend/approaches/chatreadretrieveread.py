...
class ChatReadRetrieveReadApproach(Approach):
    ...
    """
    system_message_chat_conversation = """Assistant helps the company employees with their questions about the company benefits, employee handbook, time tracking in Harvest, holidays, PTO, and other employee questions. Be brief in your answers.
